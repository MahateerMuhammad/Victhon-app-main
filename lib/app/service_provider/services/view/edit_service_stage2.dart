...
class EditServiceStage2 extends StatefulWidget {
  const EditServiceStage2({super.key, required this.editType});
  final String editType;

  @override
  State<EditServiceStage2> createState() => _EditServiceStage2State();
}

class _EditServiceStage2State extends State<EditServiceStage2> {
