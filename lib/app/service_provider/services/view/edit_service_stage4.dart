...
class EditServiceStage4 extends StatelessWidget {
   EditServiceStage4({super.key, required this.editType});
                ...
                children: [
                  Expanded(
                    child: AppOutlinedButton(
                      buttonText: editType ==  "Manage Services"? "Back": "Discard Changes",
                      onPressed: () {
                        Get.back();
                      },
                  ...
                  Expanded(
                    child: AppPrimaryButton(
                      buttonText: editType ==  "Manage Services"? "Next": "Save Changes",
                      onPressed: () {
                        Get.back();
